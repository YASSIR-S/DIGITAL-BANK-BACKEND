...
import com.yassir.digitalbank.entities.*;
...
import com.yassir.digitalbank.mappers.BankAccountMapperImpl;
...
public class BankAccountServiceImpl implements BankAccountService{
    ...
    public void debit(String accountId, double amount, String description) throws BankAccountNotFoundException, BalanceNotSufficient {
        ...
        if (bankAccount.getBalance()<amount)
            throw new BalanceNotSufficient("Balance n'est pas suffisant");
    ...
    @Override
    public void transfer(String accountIdSource, String accountIdDestination, double amount) throws BalanceNotSufficient, BankAccountNotFoundException {
